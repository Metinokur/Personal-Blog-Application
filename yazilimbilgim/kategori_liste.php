...
<div class="left">
    ...
    katagoriler.katagori_id=konular.konu_katagori inner join uyeler on uyeler.uye_adi=konular.konu_ekleyen where konu_katagori=? and konu_durum=? ");
    ...
    <div class="left2">
        ...
        <h5><i class="fa fa-tags"></i> <?php echo $x["katagori_adi"]; ?> <span style="margin-left: 12px;"><i
                    style="color: #c41a16; " class="fa fa-pencil"></i> <a style="color: #242424;  font-weight: 550;"
                    href="?do=profil&uye=<?php echo $x["uye_adi"]; ?>"> <?php echo $x["uye_adi"]; ?></a> </span>
            <span style="margin-left: 18px;"><i class="fas fa-glasses"></i> okunma:<?php echo $x["konu_hit"]; ?> </span>
            <span style=" float: right; margin-right: 8px; "><i class="far fa-calendar-alt"></i> :
                <?php  echo date("d-m-Y",strtotime($x["konu_tarih"])); ?> </span>
        </h5>
    ...
    <?php
          ...
          echo '<div class="kategori-hata-bulunmuyor"><i class="fas fa-exclamation"></i> Bu Kategoriye Ait Hiç Konu Bulunmuyor.</div>';
      }
...
<div class="right">
    ...
    <div class="right3">
        <!-- at the start of the RİGHT3 div -->
        <h1> Çok Okunanlar
            <div class="line3"></div>
        </h1>
        <?php
    ...
    <div class="right4">
        <!-- at the start of the right 4 div -->
        <h1> Son Yorumlar
            <div class="line4"></div>
        </h1>
        <?php
